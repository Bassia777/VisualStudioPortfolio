...
import { VscSymbolColor, VscTerminal, VscFiles, VscGoToFile, VscGear, VscColorMode, VscHome, VscAccount, VscCode, VscMail, VscGithubAlt, VscBriefcase } from 'react-icons/vsc';
